...
@Component({
  selector: 'app-myblue-staging',
  templateUrl: './myblue-staging.component.html',
  styleUrls: ['./myblue-staging.component.scss']
})
export class MyBlueStagingComponent implements OnInit {
  hideSampleData=true;
